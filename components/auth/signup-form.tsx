  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-400 mt-2">Join Apna Coding Community</p>
      </div>
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <Input
              ...
              className="pl-10 pr-10 bg-gray-900/50 border-gray-700 text-white placeholder-gray-400 focus:border-yellow-400"
