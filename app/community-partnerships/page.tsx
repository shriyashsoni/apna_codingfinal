...
import { Search, Users, MapPin, ExternalLink, Filter, Star, Plus } from "lucide-react"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                We're building partnerships with amazing communities worldwide. Join us in creating a stronger, more
                connected developer ecosystem.
              </p>

              {/* Empty State */}
              <div className="bg-gray-900/50 border border-yellow-500/20 rounded-lg p-12 mt-12">
                <Users className="w-16 h-16 text-gray-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-400 mb-4">No Community Partners Yet</h3>
                <p className="text-gray-500 mb-6">
                  We're actively building partnerships with tech communities, developer groups, and educational
                  institutions.
                </p>
        ...
        <section className="py-16 bg-gradient-to-r from-yellow-500/10 to-transparent">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Join our growing network of community partners and help us build the future of developer education
              together.
            </p>
            <Button asChild size="lg" className="bg-yellow-500 text-black hover:bg-yellow-400 font-semibold">
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-center">
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6">
                <div className="text-3xl font-bold text-yellow-500">{Math.max(0, categories.length - 1)}</div>
                <div className="text-gray-400">Categories</div>
              </div>
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6">
                <div className="text-3xl font-bold text-yellow-500">{featuredPartners.length}</div>
                <div className="text-gray-400">Featured Partners</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {featuredPartners.length > 0 && (
        <section className="py-16 bg-gradient-to-r from-yellow-500/5 to-transparent">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredPartners.slice(0, 6).map((partner) => (
                <Card
                  key={partner.id}
                  className="bg-gradient-to-br from-yellow-500/10 to-gray-900 border-yellow-500/30 hover:border-yellow-500/50 transition-all duration-300 group"
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-yellow-500/20 rounded-lg flex items-center justify-center overflow-hidden">
                          {partner.logo_url ? (
                            <Image
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center">All Community Partners</h2>
