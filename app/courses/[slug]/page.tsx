...
import { getCurrentUser, getCourseById, type Course } from "@/lib/supabase"
...
export default function CourseDetailPage() {
  ...
  const loadCourse = async () => {
    try {
      // Extract ID from slug (assuming format: course-name-id)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/courses")} className="bg-purple-400 hover:bg-purple-500 text-black">
